...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo dirname($_SERVER['SCRIPT_NAME']); ?>/publico/css/style.css">
...
<body>
    ...
    <!-- Custom JavaScript -->
    <script src="<?php echo dirname($_SERVER['SCRIPT_NAME']); ?>/publico/js/main.js"></script>
    
    <!-- Scripts adicionais (carregado por página) -->
    <?php if (isset($scripts)): ?>
        <?php foreach ($scripts as $script): ?>
            <script src="<?php echo dirname($_SERVER['SCRIPT_NAME']); ?>/publico/<?php echo htmlspecialchars($script); ?>"></script>
        <?php endforeach; ?>
    <?php endif; ?>
</body>
</html>
